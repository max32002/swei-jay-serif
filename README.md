...
獅尾簡中宋體基於[思源宋體](https://github.com/adobe-fonts/source-han-serif)的繁轉簡字型；可以免費商用，歡迎大家自由應用、自由優化、自由改作！

獅尾簡腿黑體的特色是：繁體字轉成簡體字的字型檔，由於是轉成簡體，所以能處理「一簡對多繁」。

![字體預覽](https://github.com/max32002/swei-jay-serif/raw/master/preview/welcome.png)
說明：繁中的「發」和「髮」在簡中都是「发」；繁中的「后」和「後」簡中都是「后」。

「獅尾繁中宋體」設計上針對筆畫粗細支援7種字重，所以不論大標、小標、簡單的段落排版都能清晰辨識。
...
## 更新日誌
[點擊此處](https://github.com/max32002/swei-jay-serif/blob/master/change_log.md) 查看更新記錄。
...
```
@font-face {
  font-family: SweiJaySerifCJKtc-Regular;
  src: url(https://cdn.jsdelivr.net/gh/max32002/swei-jay-serif@2.0/WebFont/CJK%20TC/SweiJaySerifCJKtc-Regular.woff2) format("woff2")
  , url(https://cdn.jsdelivr.net/gh/max32002/swei-jay-serif@2.0/WebFont/CJK%20TC/SweiJaySerifCJKtc-Regular.woff) format("woff");
}
```
